            ...
            <section className="section-padding-lg bg-white">
                <div className="container-custom">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 xl:gap-16 max-w-7xl mx-auto">
                        ...
                        <div className="bg-white rounded-3xl shadow-lg p-8 md:p-10 lg:p-12 text-center hover-lift border border-gray-100 transition-all duration-300 min-h-[220px] md:min-h-[260px] lg:min-h-[300px] flex flex-col">
                            <div className="flex justify-center mb-2">
                                <div className="w-16 h-16 md:w-20 md:h-20 rounded-2xl bg-gradient-to-br from-blue-100 via-indigo-100 to-rose-100 ring-1 ring-blue-200 flex items-center justify-center values-icon-compassionate">
                        ...
                        <div className="bg-white rounded-3xl shadow-lg p-8 md:p-10 lg:p-12 text-center hover-lift border border-gray-100 transition-all duration-300 min-h-[220px] md:min-h-[260px] lg:min-h-[300px] flex flex-col">
                            <div className="flex justify-center mb-2">
                                <div className="w-16 h-16 md:w-20 md:h-20 rounded-2xl bg-gradient-to-br from-blue-100 via-indigo-100 to-rose-100 ring-1 ring-blue-200 flex items-center justify-center values-icon-guidance">
                                    <svg className="w-9 h-9 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="bg-white rounded-3xl shadow-lg p-8 md:p-10 lg:p-12 text-center hover-lift border border-gray-100 transition-all duration-300 min-h-[220px] md:min-h-[260px] lg:min-h-[300px] flex flex-col">
                            <div className="flex justify-center mb-2">
                                <div className="w-16 h-16 md:w-20 md:h-20 rounded-2xl bg-gradient-to-br from-blue-100 via-indigo-100 to-rose-100 ring-1 ring-blue-200 flex items-center justify-center values-icon-community">
                                    <svg className="w-9 h-9 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="bg-white rounded-3xl shadow-lg p-8 md:p-10 lg:p-12 text-center hover-lift border border-gray-100 transition-all duration-300 min-h-[220px] md:min-h-[260px] lg:min-h-[300px] flex flex-col">
                            <div className="flex justify-center mb-2">
                                <div className="w-16 h-16 md:w-20 md:h-20 rounded-2xl bg-gradient-to-br from-blue-100 via-indigo-100 to-rose-100 ring-1 ring-blue-200 flex items-center justify-center values-icon-perspective">
                                    <svg className="w-9 h-9 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
