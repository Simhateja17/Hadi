    ...
    return (
        <div>
            ...
            <section className="min-h-screen flex items-center bg-card py-20">
                <div className="relative container-wide text-center w-full">
                    <div className="max-w-4xl mx-auto space-y-8">
                        ...
                        <div className="inline-flex items-center px-6 py-3 bg-primary-light rounded-full border border-border">
                            ...
                            <span className="text-base font-medium text-text-dark">Professional Insights</span>
                        </div>
                        ...
                        <p className="text-body text-text-medium max-w-3xl mx-auto">
                            Expert articles, professional guidance, and insights from the UK social work community. Stay informed with the latest trends, best practices, and career advice.
                        </p>

                        {/* Stats */}
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 pt-16">
                            <div className="text-center space-y-2">
                                <div className="text-4xl font-semibold text-text-dark">{safeBlogs.length}+</div>
                                <div className="text-lg text-text-muted">Expert Articles</div>
                            </div>
                            <div className="text-center space-y-2">
                                <div className="text-4xl font-semibold text-text-dark">25+</div>
                                <div className="text-lg text-text-muted">Professional Authors</div>
                            </div>
                            <div className="text-center space-y-2">
                                <div className="text-4xl font-semibold text-text-dark">5k+</div>
                                <div className="text-lg text-text-muted">Monthly Readers</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    {safeBlogs.length > 0 ? (
                        ...
                        <div className="text-center py-20 flex items-center justify-center h-full">
                            <div className="max-w-md mx-auto space-y-8">
                                ...
                                <h3 className="heading-secondary text-3xl text-text-dark">No Blog Posts Yet</h3>
                    ...
                    <div className="max-w-5xl mx-auto bg-card rounded-3xl p-12 md:p-16 card-shadow-lg border border-border">
                        <div className="grid md:grid-cols-2 gap-12 items-center">
                            <div className="space-y-6">
                                <h3 className="heading-secondary text-3xl md:text-4xl text-text-dark">
