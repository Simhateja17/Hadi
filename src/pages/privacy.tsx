export default function PrivacyPolicy() {
  return (
    <div className="max-w-4xl mx-auto px-6 pb-16" style={{ paddingTop: '100px' }}>
      ...
      <p className="text-gray-700 mb-4">You can request access, correction, deletion, or portability of your data. Contact us at team@wesocialworkers.co.uk.</p>
    </div>
  );
}
